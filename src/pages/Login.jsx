        ...
        <>
          <div className="container mx-auto mt-28 mb-28 p-5 border border-mustardGray rounded shadow-lg bg-white">
            ...
            <form id="product-form" className="space-y-4 flex flex-col w-4/5 mx-auto mt-8 mb-10">
              ...
              <button type="submit" className="text-white bg-TGreen hover:bg-mustardYellow focus:ring-4 focus:outline-none focus:ring-mustardYellow rounded-lg w-full sm:w-auto px-5 py-2.5 text-center font-bold" style={{ color: 'white' }}>등록</button>
            </form>
            <div className="mt-3 mx-auto flex justify-center gap-96 text-sm">
              <Link to='/Signup'>
                <a>회원가입</a>
              </Link>
              <Link to='/Find'>
