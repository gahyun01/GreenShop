    ...
    <nav className="flex justify-center items-center relative m-0 p-0 cursor-pointer">
      <ul className="flex relative items-center">
        <li className="pt-10 relative float-left text-sm">
          ...
          <ul className="hidden">
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">가디건/조끼</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">야상/점퍼</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">자켓/코트</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">패딩</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">플리스</a></li>
          </ul>
        </li>
        <li className="top">
          ...
          <ul className="hidden">
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">긴팔티셔츠</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">맨투맨</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">후드</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">반팔/민소매티셔츠</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">니트</a></li>
          </ul>
        </li>
        ...
        <li className="top">
          ...
          <ul className="hidden">
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">청바지</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">면바지</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">슬랙스</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">와이드팬츠</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">숏팬츠</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">조거팬츠</a></li>
            <li><a className="p-2 no-underline text-black bg-orange-200 font-bold rounded-full hover:{bg-green-900 text-white underline g-opacity-80}">기장별</a></li>
          </ul>
        </li >
        <li className="top">
          <a>가방</a>
